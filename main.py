...
def run(args):
    ...
    if args.alg == 'full':
        ...
        from solvers.popu_multi_solver import PopuMultiSolver
        solver = PopuMultiSolver(args=args, dataset=seq2seq_dataset)
    solver.run()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--p_decay', type=float, default=0.9)
    parser.add_argument('--n_moe', type=int, default=3)


    # Model configuration
    parser.add_argument('--alg', type=str, default='full', help='training methods')
    ...
    parser.add_argument('--attention_type', type=str, default='full', help='')
    ...
    parser.add_argument('--modeldir', type=str, default='./save/', help='Save directory')

    # Computation configuration
    parser.add_argument('--device', type=str, default='3', help='The device to run the program')
    parser.add_argument('--init_seed', type=int, default=0, help="Random seed")
    parser.add_argument('--logging_step', type=int, default=50, help="Random seed")
